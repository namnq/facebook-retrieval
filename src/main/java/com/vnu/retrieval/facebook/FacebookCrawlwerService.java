...
@Service
public class FacebookCrawlwerService {
    public List<User> fetchMusic(String userName, String password, int deep) throws InterruptedException {
	...
	Set<String> fbUrls = collectFriendsByDeep(profileUrl, driver, deep);
    ...
    private List<User> collectFbUsersData(Set<String> fbUrls, WebDriver driver) {
    ...
    private User collectFbUserData(String profileUrl, WebDriver driver) {
	...
	for (WebElement music : musicList) {
	    ...
	    WebElement type = music.findElement(
		    By.xpath("//div[starts-with(@id,\"pagelet_timeline_app_collection_\")]/ul/li[*]//div/div[1]/div"));
    ...
    Set<String> collectFriendsByDeep(String profileUrl, WebDriver driver, int deep) {
	int currentDeep = 0;
    ...
    Set<String> collectFriends(String profileUrl, WebDriver driver) {
